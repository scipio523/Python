...
from helpers import timeFormat, dateFormat, createContract
...
class Downloader(object):
    def __init__(self,debug=False):
        ...
        self.tws = ibConnection(port=7497, clientId=999)
...
if __name__ == '__main__':
    ...
    symbol = 'ES'
    contract = createContract(symbol, secType='FUT', exchange='GLOBEX', expiry='201612') # create contract using defaults (STK,SMART,USD)
    data = dl.requestData(contract,"20160915 16:00:00 EST", useRTH=0) # request 30-second data bars up till now
     
    data.to_csv(symbol+'.csv') # write data to csv
