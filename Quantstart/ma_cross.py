...
class MovingAverageCrossStrategy(Strategy):
    ...
    def __init__(self, symbol, bars, short_window=10, long_window=50):
        self.symbol = symbol
        self.bars = bars
...
if __name__ == "__main__":
    ...
    #strip whitespace from headers, rename Last column
    ...
    #only keep times between 9:30am - 11:00am
    df = df[df['Date'] == '2016/6/21']

    # Create a Moving Average Cross Strategy instance with a short moving
    # average window of 100 days and a long window of 400 days
    mac = MovingAverageCrossStrategy(symbol, df, short_window=10, long_window=50)
    signals = mac.generate_signals()

    # Create a portfolio of AAPL, with $100,000 initial capital
    portfolio = MarketOnClosePortfolio(symbol, df, signals, initial_capital=100000.0)
